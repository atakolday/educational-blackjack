...
class CountDisplay(ttk.LabelFrame):
    ...
    def __init__(self, parent, card_counter: CardCounter):
        ...
        """
        super().__init__(parent, text="Card Count", padding=10)
    ...
    def _create_widgets(self):
        ...
        self.running_frame.pack(fill=tk.X, pady=(0, 10))
        
        ttk.Label(self.running_frame, text="Running Count:", font=('Arial', 10, 'bold')).pack(anchor=tk.W)
        ...
        self.true_frame.pack(fill=tk.X, pady=(0, 10))
        
        ttk.Label(self.true_frame, text="True Count:", font=('Arial', 10, 'bold')).pack(anchor=tk.W)
        ...
        ttk.Label(self.status_frame, text="Status:", font=('Arial', 10, 'bold')).pack(anchor=tk.W)
        self.status_label = ttk.Label(self.status_frame, text="Neutral", font=('Arial', 12))
        self.status_label.pack(anchor=tk.W)
        
        # Decks remaining
        self.decks_frame = ttk.Frame(self)
        self.decks_frame.pack(fill=tk.X, pady=(0, 10))
        
        ttk.Label(self.decks_frame, text="Decks Remaining:", font=('Arial', 10, 'bold')).pack(anchor=tk.W)
        self.decks_label = ttk.Label(self.decks_frame, text="6.00", font=('Arial', 12))
        self.decks_label.pack(anchor=tk.W)
        
        # Penetration
        self.penetration_frame = ttk.Frame(self)
        self.penetration_frame.pack(fill=tk.X, pady=(0, 10))
        
        ttk.Label(self.penetration_frame, text="Penetration:", font=('Arial', 10, 'bold')).pack(anchor=tk.W)
        self.penetration_label = ttk.Label(self.penetration_frame, text="0.0%", font=('Arial', 12))
        self.penetration_label.pack(anchor=tk.W)
        
        # Betting multiplier
        self.betting_frame = ttk.Frame(self)
        self.betting_frame.pack(fill=tk.X)
        
        ttk.Label(self.betting_frame, text="Bet Multiplier:", font=('Arial', 10, 'bold')).pack(anchor=tk.W)
        self.betting_label = ttk.Label(self.betting_frame, text="1.0x", font=('Arial', 12))
    ...
    def update_count(self, card_counter: CardCounter):
        ...
        if running_count > 0:
            self.running_label.config(foreground='green')
        elif running_count < 0:
            self.running_label.config(foreground='red')
        else:
        ...
        if true_count > 0:
            self.true_label.config(foreground='green')
        elif true_count < 0:
            self.true_label.config(foreground='red')
        else:
            self.true_label.config(foreground='black')
        ...
        if multiplier > 1.0:
            self.betting_label.config(foreground='green')
        else:
            self.betting_label.config(foreground='black') 